...
urlpatterns = [
    ...
    path('book_class/<str:id>/dates/',
         views.create_dates, name='create_dates'),
    ...
    path('my_bookings/<str:id>/cancel_booking/<str:pk>/',
         views.cancel_booking, name='cancel_booking'),
    path('my_bookings/<str:id>/update_booking/<str:pk>/',
